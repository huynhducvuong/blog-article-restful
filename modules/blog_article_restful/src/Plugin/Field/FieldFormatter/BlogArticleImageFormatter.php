...
namespace Drupal\blog_article_restful\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'blog_article_image' formatter.
 *
 * @FieldFormatter(
 *   id = "blog_article_image",
 *   label = @Translation("Blog Article images"),
 *   field_types = {
 *     "image"
 *   },
 *   settings = {
 *     "first_image_style" = "blog_article",
 *     "other_image_style" = "blog_article_thumbnail",
 *     "image_link" = "file"
 *   }
 * )
 */
class BlogArticleImageFormatter extends ImageFormatterBase {
